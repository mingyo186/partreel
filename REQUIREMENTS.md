...
- **표준 답변 확정 (사용자 2026-07-26 "다음부턴 그냥 3번째 방법만")**: "없는 부품 어떻게 얻냐"는 질문에는 **분산 생성 한 가지만 안내한다** — "CONTRIBUTING-AGENTS.md 링크를 너의 AI에게 주고 만들어서 PR 내게 해라". 이슈 요청·request_part는 상대가 AI가 없다고 할 때만 차선으로. 이 답 자체가 파트릴의 정체성 선언.
...
### 21-B. QA 기여 크레딧 (사용자 확정 2026-07-25 "그 사람들도 QA로 기여한거잖아")
