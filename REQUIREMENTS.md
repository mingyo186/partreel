...
1. **USB-C 리셉터클 16핀** (예: TYPE-C-31-M-12 / LCSC C165948) — 일회성
2. **USB-C 6핀 전원전용** (예: 918-418K2022) — 일회성
3. **ESP32-WROOM-32E 모듈** — 일회성
4. **microSD/TF 소켓** — 일회성
5. **JST-GH 1.25mm** 시리즈 — 파라메트릭(FAMILIES config 추가)
6. **스크류 터미널블록** 5.08/3.5mm (예: KF301) — 파라메트릭(피치×극수, 별도 생성기)
