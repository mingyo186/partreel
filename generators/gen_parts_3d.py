...
def aht10():
    ...
    body = body.cut(hole)
    # 센서 패드 (열 2.7 → x±1.35), 베이스에 0.05 매립 — 1번(좌상)은 원형, 나머지 0.8 정방 (Fig.1)
    pads = [Part.makeCylinder(0.4, 0.07, App.Vector(-1.35, -1.27, -0.02))]
    for x, y in [(-1.35, 0.0), (-1.35, 1.27), (1.35, 1.27), (1.35, 0.0), (1.35, -1.27)]:
