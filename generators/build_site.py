...
def guide_page():
  ...
  <ol>
    ...
    <li>Open the symbol chooser — PartReel categories appear with 21,000+ parts, each carrying its datasheet, page and direct download URLs in the part fields</li>
  </ol>
  <p><em>Heads-up:</em> KiCad's HTTP libraries carry metadata only (that is the spec, not a PartReel limit) — placing a part inserts a placeholder symbol whose <code>PartReel</code> field links to the real symbol/footprint/3D downloads. Use it as an in-KiCad catalog browser.</p>
  <p><a href="../../">← Home</a></p>
</main>"""
